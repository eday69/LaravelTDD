...
@section('content')
    <header class="flex items-center mb-3 py-4">
        <div class="flex justify-between items-end w-full">
            <h2 class="text-gray-600 text-sm font-normal no-underline">My Projects</h2>
    ...
    <modal name="hello-world" classes="p-10 bg-card rounded-lg" height="auto">
        <h1 class="font-normal mb-15 text-center text-2xl">Let's Start Something New</h1>
        <div class="flex">
            ...
            <div class="flex-1 ml-4">
                <div class="mb-4">
                    ...
                    <input type="text" class="border border-muted-light p-2 text-xs block w-full rounded" placeholder="Task">
                </div>
    ...
    <a href="" @click.prevent="$modal.show('hello-world')">ShowModal</a>
@endsection
